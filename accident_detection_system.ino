...
#define BLYNK_TEMPLATE_NAME "IOT ACCIDENT DETECTION SYSTEM"
...
EMailSender emailSend("YOUR_EMAIL@gmail.com", "YOUR_GMAIL_APP_PASSWORD");
...
void gmail()
{
  EMailSender::EMailMessage message;
    ...
    EMailSender::Response resp = emailSend.send("RECIPIENT_EMAIL@gmail.com", message);
...
const char* _getLink4 = "https://api.thingspeak.com/update?api_key=YOUR_THINGSPEAK_API_KEY&field1="; // Thingspeak.com
...
void setup()
{
 pinMode(force,INPUT);
  ...
  // Debug console
  Serial.begin(9600);
wifiMulti.addAP("WIFI_1", "PASSWORD_1");  // add Wi-Fi networks you want to connect to
wifiMulti.addAP("WIFI_2", "PASSWORD_2");
wifiMulti.addAP("WIFI_3", "PASSWORD_3");
wifiMulti.addAP("WIFI_4", "PASSWORD_4");
wifiMulti.addAP("WIFI_5", "PASSWORD_5");
